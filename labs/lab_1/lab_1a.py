...
def main():
    ...
    name = "Aarav Sekhri" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hello, my name is Aarav and I am from New Jersey. In my freetime I like to play tennis and code.")
